...
public class PointPosition {
    ...
    //Returns true if point (x2, y2) is on the same line from (x0, y0) to (x1, y1)
    public static boolean onTheSameLine(double x0, double y0, double x1, double y1, double x2, double y2){
        return pointPosition(x0, y0, x1, y1, x2, y2) == 0;
    }

    //Returns true if point (x2, y2) is on the line segment from (x0, y0) to (x1, y1)
    public static boolean onTheLineSegment(double x0, double y0, double x1, double y1, double x2, double y2) {
        return (pointPosition(x0, y0, x1, y1, x2, y2) == 0 && (x2 > x0) && (y2 > y0) && (x2 < x1) && (y2 < y1));
    }

    //Returns the position of p2 to p0, and p1
    ...
    public static void main(String[] args) {
        ...
        //Displays whether p2 is on the left of the line from p0 to p1, right, the same line, or on the line segment
